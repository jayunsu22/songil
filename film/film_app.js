...
(function () {
  ...
  function 캔버스탭(e) {
    ...
    // 결이 있으면 원을 두 배로 키워 읽는 것을 시도했다가 뺐다(2026-09-14).
    // 검증 사진에서 메탈 30위내가 41.7% → 25.0% 로 떨어졌다 - 넓힌 원이 옆 색판을 물었다.
    // 실물 우드 사진에서는 다를 수 있으니, 그 세트가 생기면 다시 잰다(측정.js 의 넓은원 옵션).
    ...
    질의 = { lab: 색.대표색, 밝은: 색.밝은색, 어두운: 색.어두운색, 대비폭: 색.대비폭 };
